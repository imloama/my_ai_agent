...
if __name__ == "__main__":
    # main()
    # kws_word = "你好小右" # n ǐ h ǎo x iǎo y òu @你好小右
    kws_word = "小右小右" # x iǎo y òu x iǎo y òu @小右小右
    encoded_texts = text2token(texts=[kws_word], tokens="../models/sherpa-onnx-kws/tokens.txt", tokens_type="ppinyin")
    # print(type(encoded_texts))
    for i, txt in enumerate(encoded_texts):
        print(" ".join(txt)+" @"+kws_word)
